...
class MySwitch extends StatefulWidget {
  MySwitch({
    ...
    this.disabled = false,
        ...
        super(key: key) {
    toggleColor = value ? greenValidate : redNegativeWarning;
  }
  ...
  /// This property is required.
  ///
  /// [onChange] should update the state of the parent [StatefulWidget]
  ...
  Color toggleColor = greenValidate;
...
class _FlutterSwitchState extends State<MySwitch> with SingleTickerProviderStateMixin {
  late Animation<AlignmentGeometry> _toggleAnimation;
